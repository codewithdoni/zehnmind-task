...
///
/// Locales: 3
/// Strings: 231 (77 per locale)
///
/// Built on 2026-04-27 at 19:22 UTC
...
import 'translations_uz_Cyrl.g.dart' deferred as l_uz_Cyrl;
...
enum AppLocale with BaseAppLocale<AppLocale, Translations> {
	uz(languageCode: 'uz'),
	ru(languageCode: 'ru'),
	uzCyrl(languageCode: 'uz', scriptCode: 'Cyrl');
	...
	Future<Translations> build({
		...
		switch (this) {
			...
			case AppLocale.uzCyrl:
				await l_uz_Cyrl.loadLibrary();
				return l_uz_Cyrl.TranslationsUzCyrl(
					overrides: overrides,
					cardinalResolver: cardinalResolver,
					ordinalResolver: ordinalResolver,
				);
